          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>But</strong>: Création d'un cv en HTML   </li>
                <li><strong>Date du Projet</strong>: 04/11/2020</li>
                <li><a href="assets/programmes/cv-html.zip" download="CV" class="btn btn-success btn-sm">Télécharger le zip</a></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>A propos de ce projet</h2>
              <p>
                Ceci est le premier projet qui ma été donner de faire , je devais créer mon cv en HTML.
              </p>
            </div>
          </div>
